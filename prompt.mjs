...
export function buildUserInstructions({ sourceType, link, asset, targetDancerNames }) {
  const parts = [
    `Extract a dance competition schedule from a ${sourceType} source for the CompCoach mobile app.`,
    "The goal is to identify competition metadata, dancer names, routine rows, dates, times, categories, and performance types."
  ];
  ...
  parts.push(
    ...
    "If a row is clearly a header, studio banner, room note, award block, or non-performance line, exclude it.",
