export const competitionScheduleSchema = {
  ...
  schema: {
    ...
    required: ["competition", "dancers", "entries", "competitionEvents", "selectedDancers"],
    properties: {
      competition: {
        type: "object",
        additionalProperties: false,
      ...
      competitionEvents: {
        ...
        items: {
          type: "object",
          additionalProperties: false,
          required: ["id", "competitionId", "eventDate", "eventTime", "datetimeStart", "title", "type", "notes", "locationLabel"],
          properties: {
            id: { type: "string" },
            competitionId: { type: "string" },
            eventDate: { type: "string", description: "YYYY-MM-DD" },
            eventTime: { type: "string", description: "Human-readable local time like 1:20 PM" },
            datetimeStart: { type: "string", description: "ISO 8601 datetime" },
            title: { type: "string" },
            type: {
              type: "string",
